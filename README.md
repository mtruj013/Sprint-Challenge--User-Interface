...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
    ...
    Semantic HTML gives meaning to the tags.


2. Name two big differences between ```display: block;``` and ```display: inline;```.

    Display:block creates a new line, while display:inline means that the element wil be displayed on the same line.
...
5. Explain why git is valuable to a team of developers.
    ...
    Because git can be used to monitor and control code changes made during development across several people or teams.
